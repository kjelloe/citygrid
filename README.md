...
| `specs/transport-and-landmarks.md` | **A design study** (2026-09-11) — rail and a station to off-map, harbour, ferry and port, the airport, and other builders' buildings judged against this game's systems; seven proposed slices and six open questions | Before building any transport link or landmark building |
