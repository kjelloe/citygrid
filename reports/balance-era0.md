...
Numbers below belong to **era 0**. Numbers from a previous era are void,
...
- pollution over developed land 1, over the whole region 0
...
Over developed land: **1**. Over the whole region: 0.

**Confirmed and measured.** The regional average is 0 while developed land reads
1 — exactly the failure logged: a real number divided into
invisibility by thousands of empty tiles. `civic.pollutionAverage` cannot drive anything
until it is an average over developed land.

## Verdict

2 debt(s) still open after this sweep: runaway treasuries, pollution averaged over the region.
